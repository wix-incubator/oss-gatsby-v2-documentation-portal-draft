  ...
  _createClass(Layout, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props$themeStyl = _this$props.themeStyle,
          themeStyle = _this$props$themeStyl === void 0 ? _layout.default : _this$props$themeStyl,
          _this$props$customSty = _this$props.customStyle,
          customStyle = _this$props$customSty === void 0 ? '' : _this$props$customSty;
      var modifier = this.state.modifier;
      return _react.default.createElement("div", {
        className: (0, _emotion.cx)(themeStyle, customStyle, modifier)
